                ...
                <div className="hero-body">
                    <div className="container content">
                        ...
                        <p>
                            ...
                            health professionals, and other subject matter
                            experts to bring their insights and analysis over
                            breaking news and scientific reports in a way that
                            informs the public discourse with the general public
                        ...
                        <p>
                            ...
                            <a
                                target="blank"
                                href="https://climatefeedback.org/evaluation/financial-post-commentary-misrepresents-scientific-understanding-of-weather-extremes-ross-mckitrick/"
                            >
                                here
                            </a>
                            ,{' '}
                            <a
                                target="blank"
                                href="https://climatefeedback.org/evaluation/western-journal-op-ed-deceives-readers-with-completely-unsupported-claims-jay-lehr-tom-harris/"
                            >
                                here
                            </a>
                            ,{' '}
                            <a
                                target="blank"
                                href="https://climatefeedback.org/evaluation/scientists-explain-what-new-york-magazine-article-on-the-uninhabitable-earth-gets-wrong-david-wallace-wells/"
                            >
                                here
                            </a>{' '}
                            and{' '}
                            <a
                                target="blank"
                                href="https://climatefeedback.org/evaluation/global-quackery-earth-not-warmed-past-19-years-new-study-finds-joseph-curl-the-daily-wire/"
                            >
                                here
                            </a>
